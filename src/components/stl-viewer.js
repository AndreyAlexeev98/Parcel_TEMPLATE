...
import matcapPorcelainWhite from "../static/matcap-porcelain-white.jpg";
import worldImage from "../static/world-environment.jpeg"; 
...
export class StlViewer extends React.Component {
  componentDidMount() {
    ...
    const pathToStl = this.props.data;
    ...
    // добавление элемента в центр сцены (как ориентир)
    ...
    const rootViewer = document.querySelector('.stl-viewer');
    console.log(rootViewer.clientHeight)

    // renderer.setSize(window.innerWidth, window.innerHeight);
    renderer.setSize(rootViewer.clientWidth, rootViewer.clientHeight);
